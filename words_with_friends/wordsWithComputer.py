# WordswithFriends using computer to play
# Author: A. Kashinath
...
def compChooseWord(hand, wordList, n):
    ...
    for word in wordList:
        ...
        if isValidWord(word, hand, wordList):
            ...
            if (score > bestScore):
                # update your best score and best word
                bestScore = score
                bestWord = word
    ...
    while (calculateHandLen(hand) > 0) :
        ...
        # Otherwise (the input is not a single period):
            ...
            if (not isValidWord(word, hand, wordList)) :
                print('This is a terrible error! Check code!')
                break
...
def whoPlays(hand, wordList, n):
    """
    Allow the user to decide if the user plays the game or the computer 
    plays the game.
    * Input 'u'to select the user to play the game
    * Input 'u'to select the computer to play the game
    ...
    while True:
        ...
        if userChoice == 'u':
            # user plays, call playHand, break
            playHand(hand, wordList, n)
            break
        elif userChoice == 'c':
            # computer plays, call compPlayHand, break
...
def playGame(wordList):
    ...
    while toPlay:
        ...
        if playChoice == 'n':
            ...
            whoPlays(currentHand, wordList, HAND_SIZE)           
        elif playChoice == 'r':
